...
impl Renderer {
    pub(crate) unsafe fn new(
        ...
        let (vertex_shader, fragment_shader) = {
            let mut vert_file =
                Cursor::new(&include_bytes!("../../../assets/shaders/imgui.vert.spv")[..]);
            let mut frag_file =
                Cursor::new(&include_bytes!("../../../assets/shaders/imgui.frag.spv")[..]);
    ...
    pub(crate) unsafe fn split_render(
        &mut self,
        device: &Device,
        command_buffer: vk::CommandBuffer,
        draw_data: &DrawData,
    ...
    pub(crate) unsafe fn render_draw_list(
        &mut self,
        device: &Device,
        command_buffer: vk::CommandBuffer,
        draw_list: &DrawList,
    ...
    pub(crate) unsafe fn destroy(&mut self, device: &Device, ctx: &mut imgui::Context) {
...
pub(crate) unsafe fn reload_font_texture(
    device: &Device,
    ctx: &mut imgui::Context,
    command_pool: &vk::CommandPool,
